...
- The **amygdala** is attention and innate dispositions *over a rich perceptual world.* A toy with a handful of states and a scalar reward has no world to be drawn to — "what is there to be drawn to here" is meaningless — so the amygdala degenerates into a plain reward function. → shaped-reward RL.
